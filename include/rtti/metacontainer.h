...
public:
    ...
    MetaNamespace const* getNamespace(std::string_view const &name) const;
    std::size_t namespaceCount() const;
    MetaNamespace const* getNamespace(std::size_t index) const;

    MetaClass const* getClass(std::string_view const &name) const;
    ...
    MetaConstructor const* getConstructor(std::string_view const &name) const;
    template<typename ...Args>
    MetaConstructor const* getConstructor(std::string_view const &name = CONSTRUCTOR_SIG) const
    ...
    MetaMethod const* getMethod(std::string_view const &name) const;
    ...
    MetaProperty const* getProperty(std::string_view const &name) const;
    std::size_t propertyCount() const;
    MetaProperty const* getProperty(std::size_t index) const;

    MetaEnum const* getEnum(std::string_view const &name) const;
